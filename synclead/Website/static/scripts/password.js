function scorePassword() {
  ...
  function updateProgressBar() {
    ...
    const progressColor = strength > 50 ? "green" : strength > 30 ? "orange" : "red";
    ...
    if (strength < 50)
      document.getElementById("validPassword").value = "false";
    else
      document.getElementById("validPassword").value = "true"; }